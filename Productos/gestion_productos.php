...
// Modificar la consulta para buscar productos si hay un término de búsqueda
if ($busqueda) {
    $consulta = "SELECT * FROM productos WHERE nombre LIKE '%$busqueda%' OR descripcion LIKE '%$busqueda%'";
} else {
    $consulta = "SELECT * FROM productos";  // Mostrar todos los productos si no hay búsqueda
}
...
<body>
    <div class="container mt-4">
        ...
        <form action="gestion_productos.php" method="GET" class="mb-3">
            <div class="input-group">
                <input type="text" class="form-control" name="buscar" placeholder="Buscar producto..." value="<?php echo htmlspecialchars($busqueda); ?>">
